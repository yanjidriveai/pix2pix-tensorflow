...
class pix2pix(object):
    ...
    def load_random_samples(self):
        data = np.random.choice(glob('/images/val/*.png'), self.batch_size)
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            data = glob('/images/train/*.png'.format(self.dataset_name))
    ...
    def generator(self, image, y=None):
        ...
        self.d10, self.d10_w, self.d10_b = deconv2d(tf.nn.relu(e10),
            [self.batch_size, s512, s512, self.gf_dim*8], name='g_d10', with_w=True)
        d10 = tf.nn.dropout(self.g_bn_d9(self.d10), 0.5)
        d10 = tf.concat(3, [d10, e9])

        self.d9, self.d9_w, self.d9_b = deconv2d(tf.nn.relu(d10),
            [self.batch_size, s256, s256, self.gf_dim*8], name='g_d9', with_w=True)
    ...
    def test(self, args):
        ...
        sample_files = glob('/images/test/*.png'.format(self.dataset_name))
