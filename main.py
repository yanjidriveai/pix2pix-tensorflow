...
parser.add_argument('--model_name', dest='model name', default='dlmodel', help='name of model')
parser.add_argument('--epoch', dest='epoch', type=int, default=20000000, help='# of epoch')
